...
Avant tout de chose, assurez-vous d'avoir installer Perl 5 sur votre ordinateur. Vous pouvez télécharger Perl 5 depuis : [https://learn.perl.org/installing/](https://learn.perl.org/installing/).
